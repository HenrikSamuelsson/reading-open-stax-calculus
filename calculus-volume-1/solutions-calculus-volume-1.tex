...
Assuming the relation in the below table.
...
\begin{enumerate}[label=(\alph*)]
  \item The domain of the relation is the set of unique $ x $ values,
    ...
    \{ -3, -2, -1, 0, 1, 2, 3 \}
    .$$
  \item This relation is not function, each input is not assigned to exactly one output. Take for example $ x = 1 $ that can cause both $ y = -3 $ and $ y = 1 $.
\end{enumerate}
